...
Declare Function Accent
{
	...
	until ship:apoapsis>iniApoapsis and Lights = false
	{
        ...
        HUD_accent().
        userInput().
        SET pitch to ((((ship:altitude)/1000)/(tApoapsis/1000))^0.55)*90.
     ...
     // 	print " Ship Q : "+Round(ship:q,2)+"   " at (0,1).
        ...
        {
            set tPID to pidloop(0.4,0.007,0.01  ,0.5,1).
            set tPID:setpoint TO 75.
          //  set athrottle to 1.
         ...
         //   SET athrottle to tpid:update(time:seconds,eta:apoapsis).
            ...
            {
                set pitchComp to Max(-7,(40-Eta:apoapsis)/3).
            }
