...
set PowerPID to pidloop(.05,.005,.02,0,1).
...
Declare Function ClimbDescent
{
	...
	set pInput to 0.
	set VFactor to 1.
	set pitchPID to pidLoop(.03,0.004,.0015, -.5, 1).
...
{	
	...
	set AltCorrection 	to 	PIDLoop(.15,  .003, .02, -10,  10).	
	
	set pitchPID 		to 	pidLoop(.032,0.0035,.0015, -.5, 1).
	until False
	{
